...
public class AWSProfileEditorDialog extends JDialog
{
    ...
    public AWSProfileEditorDialog(Frame owner, String title, boolean modal, AWSProfile profile, BurpExtender burp)
    {
        ...
        basicPanel.add(new JLabel("Name"), newConstraint(0, 0, GridBagConstraints.FIRST_LINE_START));
        this.nameTextField = new JTextField("", TEXT_FIELD_WIDTH);
        basicPanel.add(nameTextField, newConstraint(1, 0));
        basicPanel.add(new JLabel("KeyId"), newConstraint(0, 1, GridBagConstraints.FIRST_LINE_START));
        this.keyIdTextField = new JTextField("", TEXT_FIELD_WIDTH);
        basicPanel.add(keyIdTextField, newConstraint(1, 1));
        basicPanel.add(new JLabel("SecretKey"), newConstraint(0, 2, GridBagConstraints.FIRST_LINE_START));
        this.secretKeyTextField = new JTextField("", TEXT_FIELD_WIDTH);
        basicPanel.add(secretKeyTextField, newConstraint(1, 2));
        basicPanel.add(new JLabel("Region"), newConstraint(0, 3, GridBagConstraints.FIRST_LINE_START));
        this.regionTextField = new JTextField("", TEXT_FIELD_WIDTH);
        basicPanel.add(regionTextField, newConstraint(1, 3));
        basicPanel.add(new JLabel("Service"), newConstraint(0, 4, GridBagConstraints.FIRST_LINE_START));
        this.serviceTextField = new JTextField("", TEXT_FIELD_WIDTH);
        basicPanel.add(serviceTextField, newConstraint(1, 4));
        outerPanel.add(basicPanel, newConstraint(0, 0, GridBagConstraints.FIRST_LINE_START));

        // panel for assume role fields
        this.assumeRoleCheckbox = new JCheckBox("Assume a role", false);
        outerPanel.add(assumeRoleCheckbox, newConstraint(0, 1, GridBagConstraints.FIRST_LINE_START));
        JPanel rolePanel = new JPanel(new GridBagLayout());
        rolePanel.setBorder(new TitledBorder("Role"));
        rolePanel.add(new JLabel("RoleArn"), newConstraint(0, 0, GridBagConstraints.FIRST_LINE_START));
        this.roleArnTextField = new JTextField("", TEXT_FIELD_WIDTH-2);
        rolePanel.add(this.roleArnTextField, newConstraint(1, 0));
        rolePanel.add(new JLabel("SessionName"), newConstraint(0, 2, GridBagConstraints.FIRST_LINE_START));
        this.sessionNameTextField = new JTextField("", TEXT_FIELD_WIDTH-2);
        rolePanel.add(this.sessionNameTextField, newConstraint(1, 2));
        rolePanel.add(new JLabel("ExternalId"), newConstraint(0, 1, GridBagConstraints.FIRST_LINE_START));
        this.externalIdTextField = new JTextField("", TEXT_FIELD_WIDTH-2);
        rolePanel.add(this.externalIdTextField, newConstraint(1, 1));
        outerPanel.add(rolePanel, newConstraint(0, 2, GridBagConstraints.FIRST_LINE_START));
